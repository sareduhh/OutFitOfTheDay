...
using WardrobeTest.Models;

namespace WardrobeTest.Controllers
{
    public class WardrobesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "WardrobeID,TopID,BottomID,ShoeID,AccessorieID")] Wardrobe wardrobe)
        {
            ...
            ViewBag.AccessorieID = new SelectList(db.Accessories, "AccessorieID", "Name", wardrobe.AccessorieID);
            ViewBag.BottomID = new SelectList(db.Bottoms, "BottomID", "Name", wardrobe.BottomID);
            ViewBag.ShoeID = new SelectList(db.Shoes, "ShoeID", "Name", wardrobe.ShoeID);
            ViewBag.TopID = new SelectList(db.Tops, "TopID", "Name", wardrobe.TopID);
            return View(wardrobe);
        }
